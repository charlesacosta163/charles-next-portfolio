  ...
  return (
    <div className="flex flex-col items-center gap-4 py-8">
      ...
      <div className="flex flex-col gap-2 text-center">
        <h1 className="text-[3rem] font-[900] sm:text-[2rem] tracking-tighter">
          Hello, I'm Charles 🙋
        </h1>
      ...
      <div className="flex gap-4 items-center ">
        <Link href="/about">
          <Button className="text-xl sm:text-lg p-6 transition-all bg-base2 dark:bg-base2-dark dark:text-text-dark rounded-full text-[#06287F] hover:scale-105 tracking-tighter">
            😊 About Me
          </Button>
        </Link>

        <Link href="/projects">
          <Button className="text-xl sm:text-lg p-6 transition-all bg-base1 rounded-full shadow-lg hover:scale-105 text-text-dark tracking-tighter">
            {" "}
            💻 Projects
          </Button>
        </Link>
